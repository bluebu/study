...
- **超8 是第 8 级，一级 5 本书，每 3 课一本**（L1–L3 第一本《Prince Darling》、
  L4–L6 第二本《Heidi》……），页码每本重新从 1 起。书名不跟着换，
  一课一层目录就够分：`super8/L4/p6`。打卡单「点读」抬头的 `Lesson N` 是
...
- **划线红笔黑笔都认，一行行划和整块圈起来也都认**：第一册是橙红马克笔，
  第二册（`super8/L4`，Heidi）改成直接在数字教材上画黑线。判据不共用一套
