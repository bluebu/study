...
- **超8 是第 8 级，一级 5 本书，每 3 课一本，一课一个故事**
  （L1《Prince Darling》、L4《Heidi》、L5《格列佛游记》……）。
  ⚠️ **故事名不是书名** —— 一本装 3 课就是 3 个故事，拿其中哪一个当书名都是错的
  （这儿原先写着「L4–L6 第二本《Heidi》」，是把第一课的故事名推广成了整本的名字）。
  名字里本来就没有书名这一层：slug 只有「级 / 课 / 页」。
  页码**每本**重新从 1 起，同一本里课与课接着数 —— 第二本的 L4 是 p6–31、
  L5 接着 p51–70。一课一层目录就够分：`super8/L4/p6`。
...
- **划线红笔黑笔都认，一行行划和整块圈起来也都认**：第一册是橙红马克笔，
  第二册（`super8/L4` 起）改成直接在数字教材上画黑线。判据不共用一套
